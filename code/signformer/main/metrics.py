...
# Standard WER (sclite-style / official PHOENIX evaluation): each edit
# operation costs 1. The old weights (DEL=3, INS=3, SUB=4) from the Camgoz SLT
# repo change the alignment and do NOT correspond to the WER reported in
# PHOENIX papers. With unit costs, WER = Levenshtein distance / ref length.
WER_COST_DEL = 1
WER_COST_INS = 1
WER_COST_SUB = 1
